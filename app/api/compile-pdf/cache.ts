...
const globalForCompileCache = globalThis as unknown as {
  __bibbyCompileCache__?: Map<string, CompileCacheEntry>;
};

const compileCache =
  globalForCompileCache.__bibbyCompileCache__ ??
  (globalForCompileCache.__bibbyCompileCache__ = new Map<string, CompileCacheEntry>());
